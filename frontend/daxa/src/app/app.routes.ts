...
import { SocietePageComponent } from './pages/societe-page/societe-page.component';
import { SocieteListComponent } from './pages/societe-page/societes-list/societes-list.component';
import { AddSocieteComponent } from './pages/societe-page/add-societe/add-societe.component';
import { AffectationSocUserComponent } from './pages/affectation-soc-user/affectation-soc-user.component';
import { AddAffectationComponent } from './pages/affectation-soc-user/add-affectation/add-affectation.component';
...
export const routes: Routes = [
    ...
    {
        path: 'mes-societe-page', component: MesSocieteListComponent 
    },
    ...
    },
    {
        ...
        children: [
            { path: '', component: SocieteListComponent },
            { path: 'add-societe', component: AddSocieteComponent },
        ]
    },

    {
        path: 'affectation-soc-user',
        component: AffectationSocUserComponent,
        children: [
            { path: '', component: AddAffectationComponent },
            { path: 'affectation-list', component: AffectationListComponent },
        ]
    },
    {
        path: 'profile',
